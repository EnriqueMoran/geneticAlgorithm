...
if __name__ == "__main__":   
    ...
    example = GA.GACustom(200, 25, 0.1, 0.4, 500, crossover_policy = "cyclical_crossover", mutation_policy = "swap_mutation", chromosome_values = [i for i in range(0, 25)], gen_duplication = False)
    ...
    #sol = example.solve()
    #print("\nSolution: ", sol, " fitness: ", str(example.fitness(sol)))
    #example.fitnessPlot()
